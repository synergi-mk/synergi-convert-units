...
import each = require('lodash.foreach');
...
class Converter {
  ...
  */
   ...
   */
  public checkUnitMeasurement(checkUnit: string, checkMeasure: string) {
    var found = false;
  ...
  public throwUnsupportedUnitError(what: string) {
    var validUnits = [];
  ...
  public singleSystem(unit: string) {
   ...
   * converted to.
   */
  public possibilities(measure?: string) {
    var possibilities = [];
  ...
  public possibility(originSystem) {
    var possibilities = [];
   ...
   */
  public unitsFromMeasure(measure: string) {
    return measures[measure];
  }

  private static units: Record<string, Unit> = {};
